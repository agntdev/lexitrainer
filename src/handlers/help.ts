...
const HELP =
  "Tap /start to open your study menu. Add cards in a deck, then use New session and Review due to practise them.\n\n" +
  "You can also type /add when a word comes to mind.";
